...
public class SentinelDubboProviderFilter extends AbstractDubboFilter implements Filter {
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        try {
            ...
            if (!LoadingConfigService.checkProviderSourceConfig(interfaceName)) {
                LoadingConfigService.loadingSentinelProviderConfig(interfaceName);
            }
            if (!LoadingConfigService.checkProviderSourceConfig(methodResourceName)) {
                LoadingConfigService.loadingSentinelProviderConfig(methodResourceName);
            }
